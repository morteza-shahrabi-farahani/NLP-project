...
file_path = "data/raw/initial-files/train.csv"  # Set the path to your file
usual_comments = {}
unusual_comments = {}
toxic_comments = {}
...
write_path = "./data/raw/classified/"  # Set the path to your CSV file
...
print("classification done succesfully")